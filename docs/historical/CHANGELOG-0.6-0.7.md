# Changelog — 0.6.x–0.7.x history (0.6.0 – 0.7.4)

0.6.0 through 0.7.4 releases, split out from the top-level
`CHANGELOG.md` — a follow-up to the original 0.7.2 split (issue #147)
prompted by the same complaint recurring: the live changelog had grown
too long to skim again (the 0.9.0-unreleased section alone had reached
~960 lines). Full detail preserved verbatim, just relocated — see
[`../../CHANGELOG.md`](../../CHANGELOG.md) for 0.8.0 onward. Releases
before 0.6.0 (0.1.0 – 0.5.12) are archived separately in
...
- **CHANGELOG.md split** (issue #147): pre-0.6.0 history (0.1.0
  ...
  relocated. (This entry's own file, `CHANGELOG-0.6-0.7.md`, is a
  later repeat of the same move for 0.6.0–0.7.4 — see this file's own
  header.)
...
[`../notes/PHASE_D_PIE_SIMD.md`](../notes/PHASE_D_PIE_SIMD.md) for the full
plan and [`../notes/ROADMAP.md`](../notes/ROADMAP.md) Phase D for status.
