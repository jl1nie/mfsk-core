...
use super::params::{COSTAS, DEFAULT_BP_MAX_ITER, LDPC_N, NSPS, NTONES};
...
// carved `coarse_sync.rs`; ε.4 carved `fill_symbol_spectra.rs`.
// ε.5-6 will follow with process_candidates / osd_strategy.
mod coarse_sync;
