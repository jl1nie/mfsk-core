...
/// unpacking bits ↔ symbols inside their own methods. Q65 converts each
/// six-bit LLR group into a normalized GF(64) probability distribution before
/// invoking its native QRA decoder.
///
